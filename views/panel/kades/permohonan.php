                            ...
                            <div class="row">
                                <div class="col s12">
                                    <ul class="tabs tabs-fixed-width">
                                        <li class="tab col s3"><a href="#ongoing">Surat Teragendakan</a></li>
                                        <li class="tab col s3"><a href="#accept">Surat Tertandatangani</a></li>
                                        <li class="tab col s3"><a href="#reject">Surat Tercetak</a></li>
                                    </ul>
                                </div>
...
<script src="<?=Url::to('@web/js/pages/kades/permohonan.js')?>"></script>
<?php $this->endBlock();?>